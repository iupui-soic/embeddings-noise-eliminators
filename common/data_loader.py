...
def _load_mimic_chexpert(cfg, diseases: List[str]) -> pd.DataFrame:
    ...
    # built by notebooks/00_BuildMimicSubsample.ipynb (released as
    # manifests/mimic_subsample_ids.parquet): probe-training is subsampled
    # within the official train split; official validate/test splits are
    # retained in full.
